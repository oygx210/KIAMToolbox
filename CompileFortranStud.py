...
module_name = '-m FKIAMToolboxStud '
...
skip_5 = '"ode4" "ode8" "ode45" "ode113" "ode113_old" "ntrp113" "ode87" '
...
skip_9 = '"kine2roteph" "krot2ineeph" "kine2rot" "krot2ine" "kscrs2pa" "kscrs2mer" "kmer2scrs" "kgcrs2scrs" '
skip_10 = '"kscrs2gcrs" "kgcrs2hcrs" "khcrs2gcrs" "kitrs2gcrs" "kgcrs2itrs" "kscrs2sors" "ksors2scrs" '
...
os.system(f2py_exec_command +
          ...
          'skip: ' + skip_1 + skip_2 + skip_3 + skip_4 + skip_5 + skip_6 + skip_7 + skip_8 + skip_9 + skip_10 + ':')
