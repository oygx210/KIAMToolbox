module EquationsModule
    ...
    contains
        ...
        function cmplx_moon(rvect,jd,grad_req) result(FCentCmplx)
            ...
            type(TranslationStructure) :: scrs2pa_output
            ...
            scrs2pa_output = kscrs2pa(rvect*DistUnit,jd)
            rvectPA = scrs2pa_output.NewVec
            M_SCRS_2_PA = scrs2pa_output.dNewVec
        ...
        function kEarthJ2(jd,rvect,grad_req) result(J2Force)
            ...
            logical :: grad_req
            type(TranslationStructure) :: kgcrs2itrs_output, kitrs2gcrs_output
            type(ForceStructure) :: J2Force

            kgcrs2itrs_output = kgcrs2itrs(rvect,jd)
            rvect_ITRS = kgcrs2itrs_output.NewVec
            drvect_ITRS = kgcrs2itrs_output.dNewVec
            ...
            kitrs2gcrs_output = kitrs2gcrs(F_ITRS, jd)
            F = kitrs2gcrs_output.NewVec
            dF_dF_ITRS = kitrs2gcrs_output.dNewVec
